...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) =>
        _redirect(refresh.value, state.matchedLocation),
  );
});

/// Pure so it can be unit tested without a widget tree.
@visibleForTesting
String? redirectFor(AsyncValue<AuthStatus> auth, String location) =>
    _redirect(auth, location);

String? _redirect(AsyncValue<AuthStatus> auth, String location) {
