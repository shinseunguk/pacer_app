...
mixin _$AuthSessionModel {
 ...
 String get accessToken; String get refreshToken; bool get isNewUser; bool get onboardingCompleted;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,refreshToken,isNewUser,onboardingCompleted);

@override
String toString() {
  return 'AuthSessionModel(accessToken: $accessToken, refreshToken: $refreshToken, isNewUser: $isNewUser, onboardingCompleted: $onboardingCompleted)';
}
...
@useResult
$Res call({
 String accessToken, String refreshToken, bool isNewUser, bool onboardingCompleted
});
...
/// Create a copy of AuthSessionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? refreshToken = null,Object? isNewUser = null,Object? onboardingCompleted = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  bool isNewUser,  bool onboardingCompleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSessionModel() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.isNewUser,_that.onboardingCompleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  bool isNewUser,  bool onboardingCompleted)  $default,) {final _that = this;
switch (_that) {
case _AuthSessionModel():
return $default(_that.accessToken,_that.refreshToken,_that.isNewUser,_that.onboardingCompleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  bool isNewUser,  bool onboardingCompleted)?  $default,) {final _that = this;
switch (_that) {
case _AuthSessionModel() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.isNewUser,_that.onboardingCompleted);case _:
  return null;
...
class _AuthSessionModel extends AuthSessionModel {
  const _AuthSessionModel({required this.accessToken, required this.refreshToken, this.isNewUser = false, this.onboardingCompleted = false}): super._();
...
/// Create a copy of AuthSessionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? refreshToken = null,Object? isNewUser = null,Object? onboardingCompleted = null,}) {
